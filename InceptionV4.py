...
def inception_v3_base(inputs, scope=None):
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
        ...
        with tf.variable_scope('Mixed_5d'):
            ...
            with tf.variable_scope('Branch_1'):
                branch_1 = slim.conv2d(net, 48, [1, 1], scope='Conv2d_0a_1x1')
                branch_1 = slim.conv2d(branch_1, 64, [5, 5], scope='Conv2b_0c_5x5')
            with tf.variable_scope('Branch_2'):
                branch_2 = slim.conv2d(net, 64, [1, 1], scope='Conv2d_0a_1x1')
                branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0b_3x3')
                branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0c_3x3')
        ...
        with tf.variable_scope('Mixed_6a'):
            with tf.variable_scope('Branch_0'):
                branch_0 = slim.conv2d(net, 384, [2, 2], stride=2, padding='VALID', scope='Conv2d_1a_1x1')
            with tf.variable_scope('Branch_1'):
        ...
        with tf.variable_scope('Mixed_7b'):
            ...
            with tf.variable_scope('Branch_1'):
                ...
                branch_1 = slim.conv2d(branch_1, 384, [1, 3], scope='Conv2d_0b_1x3')
                branch_1 = slim.conv2d(branch_1, 384, [3, 1], scope='Conv2d_0c_3x1')
            with tf.variable_scope('Branch_2'):
...
def inception_v3(inputs, num_classes=1000, is_training=True, dropout_keep_prob=0.8, prediction_fn=slim.softmax,
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d], stride=1, padding='SAME'):
        ...
        with tf.variable_scope('AuxLogits'):
            ...
            aux_logits = slim.conv2d(aux_logits, 768, [5, 5], weights_initializer=trunc_normal(0.01), padding='VALID',
                                     scope='Conv2d_2a_5x5')
